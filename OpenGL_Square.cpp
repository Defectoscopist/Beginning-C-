...
int main() 
{
    ...
    // Создаем IBO - буфер индексов (отрисовка по индексам) и вершинного массива VAO
    GLunit VBO, VAO, IBO;
    glGenBuffers(1, &VBO);
    ...
    //а в конце отвязать VAO для последующего использования:
        ...
        //-копируем индексы в буфер для OpenGL
    ...
    // разбиваем визуально прямоугольник на треугольники (не обязательно)
